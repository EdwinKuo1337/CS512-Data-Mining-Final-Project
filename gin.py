...
class GraphNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 =  GINConv(nn.Sequential(nn.Linear(64, 32), nn.BatchNorm1d(32)))  # first skip through conv1
        self.conv2 = GINConv(nn.Sequential(nn.Linear(32, 16), nn.BatchNorm1d(16)))

        self.conv3 = GINConv(nn.Sequential(nn.Linear(16, 16), nn.BatchNorm1d(16)))
        self.conv4 = GINConv(nn.Sequential(nn.Linear(16, 16), nn.BatchNorm1d(16)))
    ...
    def forward(self, x, edge_index):
        ...
        x = F.relu(self.conv1(x, edge_index)).reshape(dim0*dim1, -1)  # [16*1026, 32]
        ...
        x4 = F.relu(self.conv4(x3, edge_index).reshape(dim0, -1))
